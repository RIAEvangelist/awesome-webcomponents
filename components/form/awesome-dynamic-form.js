...
(
    function(){
        ...
        component.tagName='awesome-dynamic-form';

        component.create=function createAwesomeDynamicForm() {
            return class AwesomeDynamicForm extends awesome.component.BaseComponent{
                createdCallback(){
                    super.createdCallback();
                    this.classList.add(AwesomeDynamicForm.elementTagName);
